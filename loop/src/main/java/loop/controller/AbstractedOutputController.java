...
/**
 * This class represents the controller responsible for the abstracted output of a simulationï¿½s
 * result (Page 2 in the output described in the ï¿½Pflichtenheftï¿½).
 *
