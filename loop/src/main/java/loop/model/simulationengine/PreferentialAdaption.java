...
public class PreferentialAdaption implements StrategyAdjuster {
    ...
    public static Plugin<StrategyAdjuster> getPlugin() {
        if (plugin == null) {
            plugin = new PreferentialAdaptionPlugin();
        }
        return plugin;
    }
    
    private static PreferentialAdaptionPlugin plugin;
    
    private static class PreferentialAdaptionPlugin extends Plugin<StrategyAdjuster> {
