...
The name and the description of a population can be entered in corresponding text fields at the top of the creation window. Below, \(1\) to \(16\) groups can be added, each with specified size (see \cref{fig:population_creation}). Once the population configuration is completed, the population can be exported as a file. Such a file can also be imported.
...
\begin{figure}[h]
	...
	\includesvg[width = 0.5 \linewidth]{images/paketdiagramme/package_edu_kit_loop}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_simulator}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_Simulator_exception}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_simulationengine_strategies1}

	\caption{Classdiagram \texttt{edu.kit.loop.model.simulationengine} 1st part}
\end{figure}

\begin{figure}[h]
	\centering
	\fontsize{3}{8}\selectfont
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_simulationengine_strategies2}

	\caption{Classdiagram \texttt{edu.kit.loop.model.simulationengine} 2nd part}
\end{figure}
\fi
...
Realies the \enquote{Ranggleichgewicht} described in the specification.
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_simulationengine_strategies}
...
This package contains functionality for creating custom strategies by combining existing ones through logical expressions.

\iftrue
\begin{figure}[h]
	\centering
	\fontsize{5}{8}\selectfont
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_simulationengine_strategybuilder}
...
This interface represents a logical operator for combining strategies.
...
\begin{itemize}\itemsep -10pt
	...
	\item[] \texttt{strat1}: the first of the strategies to combine
	\item[] \texttt{strat2}: the second of the strategies to combine
...
This class is an operator that creates a new \texttt{Strategy} by negating the first of the two given strategies.
...
\begin{figure}[h]
	\centering
	\fontsize{6}{8}\selectfont
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_simulationengine_distribution}
...
\begin{figure}[h]
	\centering
	\fontsize{4}{8}\selectfont
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_controller}
...
This interface gets implemented by all controllers which are associated with creation windows. It provides the possibility to register a callback that gets called whenever a new instance is created.
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_plugin}
...
This class serves as a control element for the configuration of a plugin that can be dynamically embedded into the UI by the \texttt{ConfigController}. It provides functionality for querying the configuration parameters entered by the user.
...
This package contains the central repository, through which all currently available games, strategies, populations as well as pairing algorithms, success quantifications, adaptation mechanisms, equilibrium criteria and discrete distributions can be obtained.

\iftrue
\begin{figure}[h]
	\centering
	\fontsize{7.5}{8}\selectfont
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_repository}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/sequence_diagram_simulator}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/sequence_diagram_simulationengine}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/sequence_diagram_adaptionstep}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/sequence_diagram_game}
