...
This interface represents a vector of fixed size holding entities of type \texttt{T}. An implementation allows retrieving and overwriting of vector components and offers a cloning functionality.
...
\item[] Multiply the vector by the given scalar.
