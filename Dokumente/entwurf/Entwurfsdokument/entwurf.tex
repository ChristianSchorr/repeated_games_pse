...
\subsubsection{Class \texttt{TotalCapitalSuccessQuantifier}}
...
Konstruktoren:
\begin{itemize}\itemsep -10pt
\item \texttt{SlidingMeanSuccessQuantifier(int windowSize)}
\item[] Erstellt einen neuen \texttt{SlidingMeanSuccessQuantifier} mit der gegebenen Fenstergröße.
\item[] \texttt{windowSize}: die Fenstergröße für die Durchschnittsberechnung
\end{itemize}

\subsubsection{Class \texttt{PayoffInLastAdaptSuccessQuantifier}}
Implements: \texttt{SuccessQuantifier}
...
\subsubsection{Class \texttt{ReplicatorDynamicStrategyAdjuster}}
...
Konstruktoren:
\begin{itemize}\itemsep -10pt
\item \texttt{ReplicatorDynamicStrategyAdjuster(double alpha, double delta)}
\item[] Erstellt einen neuen \texttt{ReplicatorDynamicStrategyAdjuster} mit den gegebenen Parameter \(\alpha\) und \(\delta\).
\item[] \texttt{alpha}: die Vergleichswahrscheinlichkeit
\item[] \texttt{delta}: die Anpassungswahrscheinlichkeit
\end{itemize}

\subsubsection{Class \texttt{PreferentialAdaptionStrategyAdjuster}}
Implements: \texttt{StrategyAdjuster}
...
Konstruktoren:
\begin{itemize}\itemsep -10pt
\item \texttt{PreferentialAdaptionStrategyAdjuster(double alpha, double delta)}
\item[] Erstellt einen neuen \texttt{PreferentialAdaptionStrategyAdjuster} mit den gegebenen Parameter \(\alpha\) und \(\delta\).
\item[] \texttt{alpha}: die Vergleichswahrscheinlichkeit
\item[] \texttt{delta}: die Anpassungswahrscheinlichkeit
\end{itemize}
