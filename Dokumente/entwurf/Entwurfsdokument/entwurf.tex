...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_simulationengine_part1}
...
\begin{figure}[h]
	...
	\includesvg[width = \linewidth]{images/paketdiagramme/package_edu_kit_loop_model_simulationengine_part2}
...
This class represents the controller responsible for the detailed output of a simulation's result (Page 1 in the output described in the \textit{Pflichtenheft}).
...
This class represents the controller responsible for the abstracted output of a simulation's result (Page 2 in the output described in the \textit{Pflichtenheft}).
...
This class represents the controller responsible for the output of a multi-simulations abstracted multiconfiguration-results (Page 3 in the output described in the \textit{Pflichtenheft}).
