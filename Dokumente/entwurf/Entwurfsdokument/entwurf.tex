...
\begin{itemize} \itemsep -10pt
	...
	\item[] Initializes the Repository-instance by loading all available plugins in the current environment path and all saved entities from the home directory.
