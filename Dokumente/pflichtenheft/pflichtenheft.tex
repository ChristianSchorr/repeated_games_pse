...
Eine Konfiguration kann als Datei abgespeichert werden. Eine solche Konfigurationsdatei kann wiederum geladen werden. Außerdem kann die Konfiguration einer bereits abgeschlossenen Simulation als aktuelle Konfiguration übernommen werden.
